...
public class AuctionService {
    ...
    private static final String hoarseName = "Name";
          ...
          //  jedis.set("auctionStartTime", String.valueOf(auctionStartTime));
           ...
           // long currentTime = System.currentTimeMillis();
            ...
            if (System.currentTimeMillis() < endTime) {
                String key = AUCTION_KEY + ":" + hoarseName ;
                jedis.set(key, value);
                String backupKey = AUCTION_KEY + ":" + hoarseName + "backup";
                ...
                System.out.println("낙찰되었습니다 낙찰가 : "+ jedis.get(AUCTION_KEY + ":" + hoarseName));
            }
        }
    }
